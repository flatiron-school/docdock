...
```
$ git submodule add https://github.com/flatiron-school/docdock.git themes/docdock
```
...
```
$ git clone https://github.com/flatiron-school/docdock.git themes/docdock
```


### 3. Install DocDock from ZIP

All files from theme will be tracked inside parent repo, to update it, have to override files in theme. [{{%icon download%}} download following zip](https://github.com/flatiron-school/docdock/archive/master.zip) and extract inside `themes/`.

```
https://github.com/flatiron-school/docdock/archive/master.zip
```
