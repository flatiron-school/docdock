...
All files from theme will be tracked inside parent repo, to update it, have to override files in theme. [{{%icon download%}} download following zip](https://github.com/flatiron-labs/docdock/archive/master.zip) and extract inside `themes/`.
